  ...
  return (
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-full">
        ...
        />
        <div className="w-[52px] h-full rounded-full bg-[#4acd8d] flex justify-center items-center cursor-pointer">
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        />
        <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary py-4 ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transition-transform duration-300`}>
          <ul className="mb-4">
            {navlinks.map(link => (
              <li
                key={link.name}
